...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(RUOSIA).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
video = "https://t.me/World_Russiia/4"
local T =[[*
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
...
local ROUSIA = "*🔰 للخروج من التنصيب ارسل الغاء*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = Text, url = 'https://t.me/Source_Russiia'},
},
}
local msgg = msg.id/2097152/0.5
